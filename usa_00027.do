...
quietly infix                 ///
  ...
  byte    educ       106-107  ///
  int     educd      108-110  ///
  byte    migrate1   111-111  ///
  byte    migrate1d  112-113  ///
  byte    qmarst     114-114  ///
  byte    qmarinyr   115-115  ///
  byte    qdivinyr   116-116  ///
  byte    qbpl       117-117  ///
  byte    qmigrat1   118-118  ///
  using `"usa_00027.dat"'
...
label var qdivinyr  `"Data quality flag for DIVINYR"'
...
label define qdivinyr_lbl 0 `"Not allocated"'
label define qdivinyr_lbl 4 `"Allocated"', add
label values qdivinyr qdivinyr_lbl
